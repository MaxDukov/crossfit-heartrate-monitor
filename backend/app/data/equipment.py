...
EQUIPMENT_SEED = [
    {"key": "barbell",      "name": "Штанга олимпийская",       "category": "barbells",      "icon": "🏋️"},
    {"key": "pull_up_bar",  "name": "Турник",                    "category": "rig",           "icon": "🆙"},
    {"key": "rings",        "name": "Кольца гимнастические",     "category": "rig",           "icon": "💍"},
    {"key": "kettlebell",   "name": "Гиря",                      "category": "freeweights",   "icon": "🫙"},
    {"key": "dumbbell",     "name": "Гантели",                   "category": "freeweights",   "icon": "🔩"},
    {"key": "box",          "name": "Бокс (box jump)",           "category": "misc",          "icon": "📦"},
    {"key": "jump_rope",    "name": "Скакалка",                   "category": "misc",          "icon": "🪢"},
    {"key": "medball",      "name": "Медбол (wall ball)",        "category": "freeweights",   "icon": "🔵"},
    ...
    {"key": "rope_climb",   "name": "Канат",                      "category": "rig",           "icon": "🧗"},
