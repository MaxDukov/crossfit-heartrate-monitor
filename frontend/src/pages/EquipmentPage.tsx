    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white">Инвентарь зала</h1>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {checked && (
                            <input
                              ...
                              className="mt-1 w-16 bg-slate-700 text-slate-200 text-xs px-2 py-0.5 rounded border border-slate-600"
                            />
                          )}
                        </div>
                        <div
