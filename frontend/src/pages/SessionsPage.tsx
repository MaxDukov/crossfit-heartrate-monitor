...
export default function SessionsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      {active ? (
        <div className="bg-emerald-950/30 border border-emerald-500/30 rounded-lg p-4 mb-6">
      ...
      <h2 className="text-lg font-semibold mb-3 text-slate-300">История</h2>
      <div className="space-y-2">
        {sessions.map((s) => (
          ...
          >
            <div>
              <div className="font-medium">{s.name || "Тренировка"}</div>
              <div className="text-sm text-slate-400">
