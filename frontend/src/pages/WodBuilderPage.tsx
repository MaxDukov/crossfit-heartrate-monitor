  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-white mb-1">Конструктор WoD</h1>
            ...
            {THEMES.map((theme) => (
              <button
                ...
                className={`flex flex-col items-center gap-2 p-5 rounded-xl border-2 transition-all ${
                  selectedTheme === theme
                    ? "bg-blue-600/20 border-blue-600 scale-105"
        ...
        {/* Ошибка */}
        {error && (
          <div className="bg-red-950 border border-red-800 rounded-lg p-4 text-red-300 mb-4">
            {error}
          </div>
        )}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {variants.map((v, i) => (
                <div
                  key={i}
                  className="bg-slate-900 rounded-xl border border-slate-800 p-5 flex flex-col"
                >
